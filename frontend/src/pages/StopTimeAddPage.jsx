...
const StopTimeAddPage = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      Swal.fire(
        t("Error!"),
        t("Stop name, sequence number, arrival and departure time are required!"),
        "error"
      );
      return;
    }
    ...
    const result = await Swal.fire({
      ...
      text: t("Are you sure you want to add this stop time?"),
      icon: "question",
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire(t("Added!"), t("Stop time successfully added."), "success");
        ...
        Swal.fire(
          t("Error!"),
          t("Error occurred while adding stop time:") + " " + error.message,
          "error"
        );
      }
    }
