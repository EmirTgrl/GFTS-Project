...
const StopTimeAddPage = ({
  ...
  const handleChange = (e) => {
    ...
    if (name === "shape_dist_traveled" || name === "stop_sequence" || name==="stop_lat" || name==="stop_lon") {
        parsedValue = value === "" ? null : parseFloat(value);
    } else if (name === "pickup_type" || name === "drop_off_type" || name === "timepoint" || name === "location_type" || name === "wheelchair_boarding") {
